...
var _ReactTween = __webpack_require__(20);
...
exports.default = {
	ReactTween: _ReactTween2.default
};
	...
	return function (_React$Component) {
		...
		_createClass(_class, [{
			...
			value: function componentWillReceiveProps(nextProps) {
				...
				var currentStyles = _.omitBy(this.state, _.isUndefined);
				currentStyles = _.pick(currentStyles, this.animationKeys);

				var paths = _.map(currentStyles, function (data, key) {
					var json = {};
					...
					if (iterations > 0) {
						stylePath = _.times(iterations, function (i) {
			...
			value: function getCurrentFrameState() {
				...
				var frameState = {};
				_.map(this.tweenPath, function (data) {
			...
			value: function render() {
				var styles = _.omitBy(this.state, _.isUndefined);
